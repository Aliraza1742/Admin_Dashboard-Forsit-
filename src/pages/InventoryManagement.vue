      ...
      <div v-if="lowStockItems.length > 0"
        ...
        <div>
          ...
          <p class="text-yellow-700 text-sm">
            ...
            <button @click="showLowStock = !showLowStock" class="text-indigo-600 hover:underline ml-1 font-medium">
              ...
              <tr>
                <th v-for="header in headers" :key="header.key" scope="col"
                  ...
                  <div class="flex items-center">
                    {{ header.label }}
                    <ChevronUpDownIcon v-if="header.sortable" class="h-4 w-4 ml-1 text-gray-400" />
                  </div>
                </th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="product in filteredProducts" :key="product.id" class="hover:bg-gray-50 transition-colors"
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-30 w-40  overflow-hidden ">
                      <img :src="product.image || '/placeholder-product.jpg'" :alt="product.name"
                        class="h-full w-full object-contain rounded-lg" @error="handleImageError">
                    </div>
                    <div class="ml-4">
                  ...
                  <div class="flex items-center">
                    <div class="w-24 mr-3">
                      <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                        ...
                        }" :style="{ width: `${stockPercentage(product)}%` }"></div>
                      </div>
                    </div>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <button @click="openEditModal(product)" class="text-indigo-600 hover:text-indigo-900 mr-3">
                ...
                <div class="mt-4 space-y-4">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-12 w-12 rounded-lg overflow-hidden bg-gray-100 mr-4">
                      <img :src="currentProduct.image || '/placeholder-product.jpg'" :alt="currentProduct.name"
                  ...
                  <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                      <input type="number" id="stock" v-model.number="currentProduct.stock"
